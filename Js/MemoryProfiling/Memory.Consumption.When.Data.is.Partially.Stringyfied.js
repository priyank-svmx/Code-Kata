...
const containerArray = [ObjectFactory()];

log(`Memory - After creating ObjectFactory - ${MemoryInUse_MB()}`, 3);

for (let j = 0; j < 20000; j++) {
  containerArray.push(`${ObjectFactory()}`);
}
...
setTimeout(function() {
  ...
  log(
    `Partially Stringified - Effective Memory Utilized - After creating 20k Objects - with 15 properties Each - ${inMB(
